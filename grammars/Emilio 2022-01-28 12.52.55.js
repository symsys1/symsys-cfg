...
var grammar = {
    ...
    {"name": "MAIN", "symbols": ["SMEAGOLEMERGING", {"literal":"!","pos":12}]},
    ...
    {"name": "SMEAGOLEMERGING$string$1", "symbols": [{"literal":"S"}, {"literal":"m"}, {"literal":"e"}, {"literal":"a"}, {"literal":"g"}, {"literal":"o"}, {"literal":"l"}, {"literal":" "}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "SMEAGOLEMERGING$subexpression$1", "symbols": ["REASONFORLIVING"]},
    {"name": "SMEAGOLEMERGING$subexpression$1$subexpression$1$string$1", "symbols": [{"literal":","}, {"literal":" "}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "SMEAGOLEMERGING$subexpression$1$subexpression$1", "symbols": ["SMEAGOLEMERGING$subexpression$1$subexpression$1$string$1", "SMEAGOLEMERGING"]},
    {"name": "SMEAGOLEMERGING$subexpression$1", "symbols": ["SMEAGOLEMERGING$subexpression$1$subexpression$1"]},
    {"name": "SMEAGOLEMERGING", "symbols": ["SMEAGOLEMERGING$string$1", "GOODDOING", "_", "GOLLUMACTION", "_", "HATE", "_", "SMEAGOLEMERGING$subexpression$1"]},
